...
int main(int argc, char* argv[]) {
	...
	//float* CPMFloats = (float*)LockResource(LoadResource(NULL, FindResource(NULL, MAKEINTRESOURCE(PokemonCPMFile), RT_RCDATA)));
...
#pragma warning(suppress:26451)
	...
	//PokemonStatsStruct* PokemonStats = (PokemonStatsStruct*)LockResource(LoadResource(NULL, FindResource(NULL, MAKEINTRESOURCE(PokemonStats2File), RT_RCDATA)));
...
#pragma warning(suppress:26451)
	...
	//char* EndMySuffering2 = (char*)LockResource(LoadResource(NULL, FindResource(NULL, MAKEINTRESOURCE(FMLFile), RT_RCDATA)));
	...
	FILE* GenericFile = fopen("F:\\My Programming Stuff Expansion\\ExcelFileTest\\xl\\worksheets\\sheet1.xml", "w+b");
